...
void Application::sub_533c34(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533c34  ff2528475300           -jmp dword ptr [0x534728]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457704), cpu);
}

/* align: skip  */
void Application::sub_533c3a(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533c3a  ff252c475300           -jmp dword ptr [0x53472c]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457708), cpu);
}

/* align: skip  */
void Application::sub_533c40(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533c40  ff25a4475300           -jmp dword ptr [0x5347a4]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457828), cpu);
}

/* align: skip  */
void Application::sub_533c46(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533c46  ff254c475300           -jmp dword ptr [0x53474c]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457740), cpu);
}

/* align: skip  */
void Application::sub_533c4c(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533c4c  ff257c475300           -jmp dword ptr [0x53477c]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457788), cpu);
}

/* align: skip  */
void Application::sub_533c52(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533c52  ff2504475300           -jmp dword ptr [0x534704]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457668), cpu);
}

/* align: skip  */
void Application::sub_533c58(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533c58  ff25ec465300           -jmp dword ptr [0x5346ec]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457644), cpu);
}

/* align: skip  */
void Application::sub_533c5e(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533c5e  ff2524475300           -jmp dword ptr [0x534724]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457700), cpu);
}

/* align: skip  */
void Application::sub_533c64(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533c64  ff2530475300           -jmp dword ptr [0x534730]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457712), cpu);
}

/* align: skip  */
void Application::sub_533c6a(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533c6a  ff25f0465300           -jmp dword ptr [0x5346f0]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457648), cpu);
}

/* align: skip  */
void Application::sub_533c70(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533c70  ff2588475300           -jmp dword ptr [0x534788]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457800), cpu);
}

/* align: skip  */
void Application::sub_533c76(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533c76  ff253c475300           -jmp dword ptr [0x53473c]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457724), cpu);
}

/* align: skip  */
void Application::sub_533c7c(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533c7c  ff25a0475300           -jmp dword ptr [0x5347a0]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457824), cpu);
}

/* align: skip  */
void Application::sub_533c82(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533c82  ff256c475300           -jmp dword ptr [0x53476c]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457772), cpu);
}

/* align: skip  */
void Application::sub_533c88(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533c88  ff25a8475300           -jmp dword ptr [0x5347a8]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457832), cpu);
}

/* align: skip  */
void Application::sub_533c8e(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533c8e  ff2590475300           -jmp dword ptr [0x534790]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457808), cpu);
}

/* align: skip  */
void Application::sub_533c94(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533c94  ff25f4465300           -jmp dword ptr [0x5346f4]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457652), cpu);
}

/* align: skip  */
void Application::sub_533c9a(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533c9a  ff2584475300           -jmp dword ptr [0x534784]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457796), cpu);
}

/* align: skip  */
void Application::sub_533ca0(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533ca0  ff2500475300           -jmp dword ptr [0x534700]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457664), cpu);
}

/* align: skip  */
void Application::sub_533ca6(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533ca6  ff2568475300           -jmp dword ptr [0x534768]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457768), cpu);
}

/* align: skip  */
void Application::sub_533cac(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533cac  ff2578475300           -jmp dword ptr [0x534778]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457784), cpu);
}

/* align: skip  */
void Application::sub_533cb2(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533cb2  ff2570455300           -jmp dword ptr [0x534570]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457264), cpu);
}

/* align: skip  */
void Application::sub_533cb8(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533cb8  ff2580455300           -jmp dword ptr [0x534580]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457280), cpu);
}

/* align: skip  */
void Application::sub_533cbe(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533cbe  ff2558445300           -jmp dword ptr [0x534458]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5456984), cpu);
}

/* align: skip  */
void Application::sub_533cc4(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533cc4  ff2554475300           -jmp dword ptr [0x534754]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457748), cpu);
}

/* align: skip  */
void Application::sub_533cca(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533cca  ff2540475300           -jmp dword ptr [0x534740]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457728), cpu);
}

/* align: skip  */
void Application::sub_533cd0(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533cd0  ff257c455300           -jmp dword ptr [0x53457c]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457276), cpu);
}

/* align: skip  */
void Application::sub_533cd6(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533cd6  ff2534455300           -jmp dword ptr [0x534534]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457204), cpu);
}

/* align: skip  */
void Application::sub_533cdc(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533cdc  ff2564445300           -jmp dword ptr [0x534464]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5456996), cpu);
}

/* align: skip  */
void Application::sub_533ce2(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533ce2  ff2570445300           -jmp dword ptr [0x534470]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457008), cpu);
}

/* align: skip  */
void Application::sub_533ce8(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533ce8  ff256c445300           -jmp dword ptr [0x53446c]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457004), cpu);
}

/* align: skip  */
void Application::sub_533cee(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533cee  ff251c465300           -jmp dword ptr [0x53461c]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457436), cpu);
}

/* align: skip  */
void Application::sub_533cf4(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533cf4  ff25e4455300           -jmp dword ptr [0x5345e4]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457380), cpu);
}

/* align: skip  */
void Application::sub_533cfa(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533cfa  ff2534475300           -jmp dword ptr [0x534734]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457716), cpu);
}

/* align: skip  */
void Application::sub_533d00(WinApplication* app, x86::CPU& cpu)
{
  NFS2_USE(cpu);
  NFS2_USE(app);
    // 00533d00  ff25dc445300           -jmp dword ptr [0x5344dc]
    return app->dynamic_call(*app->getMemory<x86::reg32>(5457116), cpu);
}
