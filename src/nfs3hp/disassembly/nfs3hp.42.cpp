...
L_0x004fff6f:
    ...
    {
        x86::reg32& tmp = *app->getMemory<x86::reg32>(x86::reg32(10468524) /* 0x9fbcac */);
...
L_0x004fff87:
    ...
    {
        x86::reg32& tmp = *app->getMemory<x86::reg32>(x86::reg32(10468520) /* 0x9fbca8 */);
        cpu.flags.of = ~(1 & (tmp >> 31));
        tmp++;
        cpu.flags.of &= 1 & (tmp >> 31);
        cpu.set_szp(tmp);
...
L_0x004fff94:
    ...
    {
        x86::reg32& tmp = *app->getMemory<x86::reg32>(x86::reg32(10468528) /* 0x9fbcb0 */);
        cpu.flags.of = ~(1 & (tmp >> 31));
        tmp++;
        cpu.flags.of &= 1 & (tmp >> 31);
        cpu.set_szp(tmp);
