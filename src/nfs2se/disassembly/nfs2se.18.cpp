...
void Application::sub_47cc70(WinApplication* app, x86::CPU& cpu)
{
  ...
  NFS2_USE(app);
    ...
    *app->getMemory<x86::reg32>(x86::reg32(5015768) /* 0x4c88d8 */) = cpu.eax;
    ...
    {
        x86::reg32& tmp = *app->getMemory<x86::reg32>(x86::reg32(5015784) /* 0x4c88e8 */);
        cpu.flags.of = ~(1 & (tmp >> 31));
        tmp++;
        cpu.flags.of &= 1 & (tmp >> 31);
        cpu.set_szp(tmp);
    ...
    {
        x86::reg32& tmp = *app->getMemory<x86::reg32>(x86::reg32(5015780) /* 0x4c88e4 */);
        cpu.flags.of = ~(1 & (tmp >> 31));
        tmp++;
        cpu.flags.of &= 1 & (tmp >> 31);
        cpu.set_szp(tmp);
    ...
    {
        x86::reg32& tmp = *app->getMemory<x86::reg32>(x86::reg32(5015776) /* 0x4c88e0 */);
        cpu.flags.of = ~(1 & (tmp >> 31));
        tmp++;
        cpu.flags.of &= 1 & (tmp >> 31);
        cpu.set_szp(tmp);
    ...
    {
        x86::reg32& tmp = *app->getMemory<x86::reg32>(x86::reg32(5015772) /* 0x4c88dc */);
        cpu.flags.of = ~(1 & (tmp >> 31));
        tmp++;
        cpu.flags.of &= 1 & (tmp >> 31);
        cpu.set_szp(tmp);
    ...
    {
        x86::reg32& tmp = *app->getMemory<x86::reg32>(x86::reg32(5015768) /* 0x4c88d8 */);
        cpu.flags.of = ~(1 & (tmp >> 31));
        tmp++;
        cpu.flags.of &= 1 & (tmp >> 31);
        cpu.set_szp(tmp);
